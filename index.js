...
question_1.addEventListener('click', () => {
  ...
  typing(
    ...
    哈囉！我想請問貴店領養毛孩的流程和手續~
    `,
    `歡迎預約來現場看過貓狗🙂有認養意願後找老闆談談詢問相關細節（聊聊天)。以下是認養流程：<br>
     🐾一週冷靜期<br>
     🐾思考後確定自己真的想養<br>
     🐾主動聯繫老闆<br>
     🐾帶貓狗回家一起過一輩子
...
function typing(fromCustomer, fromUs1, fromUs2) {
  ...
  timer_us_1 = setTimeout(() => (us_1.innerHTML += fromUs1), 800)
...
// navMobileBtn的控制
const navMobileBtn = document.querySelector('.logo-mobile'),
  ...
  svgCat= document.querySelector('svg')
